...
function ShowcaseCard({
  ...
  return (
    <Card className="bg-gradient-to-br from-[#1A0E2E] to-[#0A0A0A] border-purple-800/30 p-6 shadow-lg hover:shadow-purple-800/20 transition-all duration-300">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button 
                  variant="outline" 
                  className="bg-transparent border-2 border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white px-8 py-3 rounded-full text-lg shadow-lg transition-all duration-300"
